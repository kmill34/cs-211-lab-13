...
void slore2_kmill34()
{
  printf("Sebastian Lorenzo and Keegan Miller\n");
  printf("We learned that we have a lot to learn about git and github. We need to learn how to work with the repository better");
